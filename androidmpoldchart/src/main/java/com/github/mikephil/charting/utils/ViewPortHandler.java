...
public class ViewPortHandler {
    ...
    public void limitTransAndScale(Matrix matrix, RectF content) {
        limitTransAndScale(matrix,content,0,0);
    }

    public void limitTransAndScale(Matrix matrix, RectF content,float xScale,float yScale) {
     ...
     * 设置默认x scale大小
     */
    public void setDefaultScaleX(float scaleX){
        limitTransAndScale(mMatrixTouch, mContentRect,scaleX,0);
    }

    /***
     * 设置默认y scale大小
     */
    public void setDefaultScaleY(float scaleY){
        limitTransAndScale(mMatrixTouch, mContentRect,0,scaleY);
    }

    /***
     * 设置默认x,y scale大小
     */
    public void setDefaultScaleXY(float scaleX,float scaleY){
        limitTransAndScale(mMatrixTouch, mContentRect,scaleX,scaleY);
    }
