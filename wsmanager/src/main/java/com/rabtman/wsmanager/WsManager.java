    ...
    private void initWebSocket() {
        ...
        if (mRequest == null) {
            mRequest = new Request.Builder()
                    .url(wsUrl)
                    .addHeader("Cookie", "__jsluid=ca116d899bf3fb75ad3a35ce3f2c8f0c; zJSESSIONID=293327041B28684C8AE21309093FAB14")
                    .addHeader("Sec-WebSocket-Extensions", "permessage-deflate; client_max_window_bits")
                    .addHeader("Sec-WebSocket-Key", "mQqbyvm/ELK6b8kHwb+1TA==")
                    .addHeader("Upgrade", "websocket")
                    .addHeader("Connection", "Upgrade")
                    .addHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.104 Safari/537.36 Core/1.53.4620.400 QQBrowser/9.7.13014.400")
                    .build();
        }
